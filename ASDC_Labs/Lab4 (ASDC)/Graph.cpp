...
// Задание 3
/*В первом случае - направленном графе - каждый нод содержит ссылки на своих соседей, с которыми он напрямую соединен. 
В пямяти это отображается однонаправленными связями (ссылками). 
Во втором случае - ненаправленном графе - каждый нод содержит ссылку на все соседние ноды.
Здесь уже в памяти это отображается, как двунаправленная связь. Информация о соседях хранится в каждом ноде все зависимости от направления.*/